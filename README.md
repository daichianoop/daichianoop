...
<p align="center">
  <img src="https://backend.codecrafters.io/progress/shell/e9b352f3-81b3-468e-bf52-ab2c3b339d9c" alt="CodeCrafters Shell Progress" />
</p>

---

### 🚀 About Me
* 🛠️ **Current Focus:** Developing innovative projects with **Solidity**, **Next.js**, and **Tailwind CSS**.
* 🧠 **AI/ML:** Exploring **Image Processing** models and Machine Learning applications.
* 🤝 **Collaborations:** Open to projects involving **React.js**, **MongoDB**, **Firebase**, and **Web3** integrations.
* 📖 **Learning:** Deepening my expertise in **JavaScript**, **Solidity**, **Shell scripting**, and **Java**.
* 🎨 **Passion:** Combining technology and creativity to drive innovation.
...
<p align="center">
  <i>"Pushing technological boundaries, one line of code at a time."</i>
</p>
